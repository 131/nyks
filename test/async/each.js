...
describe("each", function() {
  ...
  it('each error', async function() {
    try {
      await each([1,2,3], async function (x){ throw 'error'; });
      throw "Never here";
    } catch(err) {
  ...
  it('each empty array, with other property on the array', async function () {
    ...
    await each(myArray, async function (x){ throw 'error'; });
  ...
  it('eachSeries empty array', async function () {
    await eachSeries([], async function (x){ assert(false, 'iteratee should not be called') });
    assert(true, 'should call callback');
  });
  ...
  it('eachLimit empty array', async function () {
    await eachLimit([], 2, async function (x) {
  ...
  it('eachLimit does not continue replenishing after error', async function () {
    ...
    await [ async function(){
      try {
        await eachLimit(arr, limit, async function (x) {
          started ++;
          if (started === 3)
            throw "Test Error";
          await sleep(delay);
